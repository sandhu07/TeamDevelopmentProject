...
(function() {
    ...
    Healthcare.ModalStatic = {};

    Healthcare.ModalStatic.list = [];

    // hide the last one
    Healthcare.ModalStatic.hide = function() {
    ...
    Healthcare.ModalStatic.remove = function(modal) {
        var list = Healthcare.ModalStatic.list;
    ...
    Healthcare.ModalStatic.close = function(result) {
        Healthcare.ModalStatic.result(result);
        Healthcare.ModalStatic.hide();
    };

    Healthcare.ModalStatic.result = function(r) {
        var list = Healthcare.ModalStatic.list;
        if (list.length > 0) {
    ...
    Healthcare.ModalStatic.displayed = function(modal) {
        var list = Healthcare.ModalStatic.list;
        for (var i = 0; i < list.length; i++) {
            if (list[i] === modal) {
                return true;
    ...
    Healthcare.Modal = function(options) {
        ...
        this.showHtml = function(html) {
            ...
            if (Healthcare.ModalStatic.displayed(this)) {
        ...
        this.update = function() {
            ...
            Healthcare.ModalStatic.list.push(this);
        ...
        this.hide = function() {
            ...
            //Healthcare.ModalStatic = null;
            Healthcare.ModalStatic.remove(this);
    ...
    Healthcare.Modal.close = function(result) {
        if (parent && parent.Healthcare && parent.Healthcare.ModalStatic) {
            parent.Healthcare.ModalStatic.close(result);
        }
        else {
